    ...
    return (
        <div className='bg-white'>
            <div className='flex items-center justify-between mx-auto max-w-7xl h-16'>
                <div>
                    <h1 className='text-2xl font-bold'>Job<span className='text-[#f80a06]'>App</span></h1>
                </div>
                    ...
                    </ul>
                    {
                        !authUser ? (
                            <div className='flex items-center gap-2'>
                                ...
                                <Link to="/signup"><Button className="bg-[#da199d] hover:bg-[#5f32ad]">Signup</Button></Link>
                            </div>
                        ) : (
                            <ProfilePopover />
                        )
